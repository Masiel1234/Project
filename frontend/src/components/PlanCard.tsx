...
const PlanCard: React.FC<PlanCardProps> = ({ name, price }) => {
  ...
  return (
    <div className="p-6 border border-gray-200 rounded-2xl shadow-md w-full max-w-2xs flex flex-col items-center text-center hover:shadow-lg transition-shadow duration-300 bg-white">
